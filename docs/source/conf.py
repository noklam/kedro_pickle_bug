...
# kedro_pickle_bug documentation build
...
from kedro_pickle_bug import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_pickle_bug"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "kedro_pickle_bugdoc"
...
latex_documents = [
    (
        master_doc,
        "kedro_pickle_bug.tex",
        "kedro_pickle_bug Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_pickle_bug",
        "Project kedro_pickle_bug codebase.",
        "Data-Science",
    )
]
